# Plausible Scenario Tests (PST) — GoTo Meeting Connector
...
- `connect_goto_meeting`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_goto_meeting`: validated contract & error handling
- `list_meetings`: validated contract & error handling
- `get_meeting`: validated contract & error handling
- `create_meeting`: validated contract & error handling
- `delete_meeting`: validated contract & error handling
- `audit_goto_health`: validated contract & error handling
